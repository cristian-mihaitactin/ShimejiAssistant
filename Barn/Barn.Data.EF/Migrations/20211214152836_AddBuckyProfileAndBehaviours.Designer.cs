...
namespace Barn.Data.EF.Migrations
{
    ...
    [Migration("20211214152836_AddBuckyProfileAndBehaviours")]
    partial class AddBuckyProfileAndBehaviours
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Barn.Entities.BuckyBehaviour", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Barn.Entities.BuckyProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Barn.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5223ca42-ba77-4e03-961b-d197b54d046f",
            ...
            modelBuilder.Entity("Barn.Entities.Users.UserPreferences", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuckyProfileID = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("Barn.Entities.BuckyBehaviour", b =>
                {
                    b.HasOne("Barn.Entities.BuckyProfile", "BuckyProfile")
                        .WithMany("Behaviours")
